<?php
    ...
    $sql1=$conn->query("select copies from books_data where book_id=1015" ); 
    $data_analysis=$sql1->fetch_all();
    $ret1=$conn->query("select book_id from return_data where member_id=$member_id and book_id=1015");
    $r1=$ret1->fetch_all();
    if($type==1)
    {
