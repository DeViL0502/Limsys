...
<html lang="en">
    <head>
        ...
        <link href="search_pg.css" rel="stylesheet">
        <link href="universal.css" rel="stylesheet">
        <link href="computer_page.css" rel="stylesheet">
        <script>
    ...
    <body>
        ...
        <div class="box">
            <h1 class="search-text">You Searched For "<?php echo $name ?>"</h1>
            <div class="sem1">
                <div class="sem1-card-search">
                    <?php
                    if(count($data)==0){
                        echo ('<div class="no-book">');
                        echo('<img src="no_book.jpg" alt="" class="no-book-img">');
                        echo ('<p class="no-book-text">No Book Found</p>');
                        echo ('</div>');
                    }
